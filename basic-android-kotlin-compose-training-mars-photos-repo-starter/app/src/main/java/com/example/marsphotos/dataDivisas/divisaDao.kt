...
interface divisaDao {
    ...
    @Query("SELECT * FROM divisaEntity WHERE Date BETWEEN :startDate AND :endDate")
    fun getDivisasByDateRange(startDate: String, endDate: String): Flow<List<divisaEntity>>
